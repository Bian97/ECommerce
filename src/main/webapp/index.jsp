...
<body>
    ...
    <div class="header">
        <div class="container">
            ...
            <div class="row">
                <div class="col-2">
                    <h1> Melhores Computadores aqui!<br>Confira j�!</h1>
                    <p>Confira j� os computadores com as pe�as mais recentes do mercado.<br> Basta voc� clicar no bot�o abaixo e aproveitar os melhores pre�os e as melhores m�quinas!</p>
